...
You can download and extract the binaries anywhere you like. For example:

**Linux / macOS:**

```bash
# Download and extract
curl -LO https://github.com/your-username/copycat/releases/latest/download/copycat-linux-x86_64.tar.xz
